...
ConfigBodySchema = Schema.from_dict({
    ...
    "xValues": fields.List(required=True, allow_none=False, cls_or_instance=fields.Integer()),
    "yCoordLable": fields.String(required=True, allow_none=False),
    "yValues": fields.List(required=True, allow_none=False, cls_or_instance=fields.Integer()),
